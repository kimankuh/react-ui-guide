                ...
                <ul className={styles.sidebar}>
                    {menus.map((menu) => (
                        <li key={menu.path} className={styles["sidebar-item"]}>
                            <NavLink to={menu.path} end={menu.end} className={({ isActive }) => `${styles["sidebarLink"]} ${isActive ? styles.active : ''}`}>{menu.name}</NavLink>
                        </li>
                    ))}
                    ...
                    <li className={styles["sidebar-item"]}>
                        ...
                        <NavLink to="/" className={({ isActive }) => `${styles["sidebarLink"]} ${isActive ? styles.active : ''}`}>Home</NavLink>
                    </li>
                
                    {/* 그냥 링크 */}
                    <li className={styles["sidebar-item"]}>
                        <Link to="/etc" className={styles["sidebarLink"]}>링크</Link>
                    </li>
                </ul>
            </nav>
        </div>
